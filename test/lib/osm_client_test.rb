...
class OsmClientTest < ActiveSupport::TestCase
  ...
  test "builds correct address details for Piešťany" do
    ...
    address = OsmClient.build_address_details(JSON.parse(details))
    m, _ = Municipality.find_by_address(city: address.city, municipality: address.municipality, suburb: address.suburb, street: address.street)
  ...
  test "builds correct address details for Bratislava Staré Mesto if inactive and street is not whitelisted for Bratislava" do
    ...
    assert_equal [ nil, municipality_districts("stare_mesto_ba") ], [ m, d ]
  end
