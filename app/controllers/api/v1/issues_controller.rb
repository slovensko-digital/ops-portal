class Api::V1::IssuesController < ApiController
  ...
  def show
    allowed_article_types = [ :agent_portal_comment, :agent_portal_and_backoffice_comment, :agent_backoffice_comment ]
    ...
    allowed_article_types += [ :unknown_user_portal_comment, :user_portal_comment ] if params[:include_customer_activities] == "true"
